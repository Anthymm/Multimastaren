    ...
    <div class="bgBoxTest">
        ...
        <div id="questionContainer">
            ...
            <input type="number" id="userAnswer" v-model="userAnswer" min="0" max="999" :disabled="inputDisabled"
                ref="numberInput" @keyup.enter="switchBtn ? onAnswer() : nextQuestion()" />
            <input type="button" id="AnswerAndNextQuestionBtn" @click="switchBtn ? onAnswer() : nextQuestion()"
                @keydown.enter="switchBtn ? onAnswer() : nextQuestion()" :value="btnText" :disabled="btnDisabled"
                ref="buttonInput" />
            <p>{{ correctAnswer }}</p>
